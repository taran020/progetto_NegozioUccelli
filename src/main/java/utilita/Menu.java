...
public class Menu 
{
    ...
    public int sceltaMenu()
    {
        ...
        do
        {
            ...
            //sia un numero compreso fra 0 e 11
            
            if (sceltaStringa.charAt(0) < '0' || Integer.parseInt(sceltaStringa) > 11)
            {
                sceltaOK=false;
            ...
            else
            {
                ...
                //sceltaStringa
                String s="0";
                scelta=Integer.parseInt(s+sceltaStringa);
